...
-- 2) Trigger kiểm tra số lượng hàng tồn kho trước khi thêm vào order_items
DELIMITER $$
...
-- 3) Trigger cập nhật tổng tiền đơn hàng sau khi thêm sản phẩm vào order_items
DELIMITER $$
...
-- 4) Trigger kiểm tra hàng tồn kho trước khi cập nhật số lượng sản phẩm trong order_items
DELIMITER $$
...
-- 5) Trigger cập nhật tổng tiền khi thay đổi số lượng hoặc giá sản phẩm trong order_items
DELIMITER $$
...
-- 7) Trigger hoàn trả số lượng hàng vào kho sau khi xóa một sản phẩm khỏi order_items
DELIMITER $$
